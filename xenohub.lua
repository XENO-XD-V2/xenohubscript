...
if _G.FastAttack then
    ...
    local function SafeWaitForChild(parent, childName)
        ...
        if not success or not result then
            warn("Xeno Hub: Missing dependency: " .. childName)
        end
        return result
    end
...
-- Execution Guard
if _G.XenoHubUI_Loaded then
    pcall(function() _G.XenoHubUI_Library:Destroy() end)
end
_G.XenoHubUI_Loaded = true
...
if not success_win then
    RayWindow = Rayfield:CreateWindow({
        Name = "Xeno Hub | Blox Fruits",
        LoadingTitle = "Xeno Hub",
        LoadingSubtitle = "by Xeno Hub",
...
if not success or not Window then
    warn("Xeno Hub: Failed to initialize Rayfield UI. Error: " .. tostring(Window))
    return
end
